...
#define DUMP_MATRIX(filename, pBuf, col, row, DATATYPE) dump_matrix(filename, pBuf, col, row, DATATYPE);
#define LOAD_MATRIX(filename, ppBuf, col, row, DATATYPE) load_matrix(filename, ppBuf, col, row, DATATYPE);
#else
...
#define DUMP_MATRIX(filename, pBuf, col, row, DATATYPE) ;
#define LOAD_MATRIX(filename, ppBuf, col, row, DATATYPE) ;
#endif
